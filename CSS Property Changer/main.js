...
//RGBA background color changer
for (let i = 0; i < rgbaInputs.length; i++) {
rgbaInputs[i].addEventListener('change', function () {
    blockE1.style.backgroundColor = 'rgba('+ rgbaR.value +',' + rgbaG.value + ',' + rgbaB.value + ',' + rgbaA.value + ')';   
})
