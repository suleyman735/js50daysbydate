...
function getRandomCat() {
    ...
    .then(responseData => {
        cat.innerHTML = `<img src="${responseData.image}" />`;
    });
...
function getRandomFox() {
    fetch("https://randomfox.ca/floof/")
    .then((response) => response.json())
    .then(responseData =>   fox.innerHTML = `<img src="${responseData.image}" />`);
...
function getRandomDog() {
    ...
    .then((response) => response.json())
    .then(responseData =>   dog.innerHTML = `<img src="${responseData.url}" />`);
